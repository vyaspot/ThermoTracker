...
- **Sensor Initialization**: Configurable sensors via YAML files
- **Data Simulation**: Realistic temperature generation with noise
...
### Create branch structure and commit

#### branches:
    main, develop and feature_1, **feature_2

#### commits:
    feat: This is initial commits, issue is resolve #1
